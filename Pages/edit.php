...
if ($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    if (isset($_POST['submit'])) {
        ...
        $success = edit_task($user, $title, $content, $dueDate);
        if ($success){
            echo 'Task edited';
        } else{
            echo 'Task failed to edit';
        }
    }
}
?>
    ...
    <div class="card-body">
        <form method="post">
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="taskTitle" name="taskTitle" value="<?php echo $_POST['title'] ?? ''; ?>" required>
            </div>
            <div class="mb-3">
                <label for="taskContent" class="form-label">Contents</label>
                <textarea class="form-control" id="taskContent" name="taskContent"  rows="3" required><?php echo $_POST['contents'] ?? ''; ?></textarea>
            </div>
            <div class="mb-3">
